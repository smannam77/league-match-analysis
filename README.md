...
League of Legends is a competitive 5v5 strategy game where early advantages can snowball 
into decisive wins. In professional play, teams closely track performance metrics such as 
...
outcome* of a match. Using match data from the 2022 season, we perform exploratory data 
